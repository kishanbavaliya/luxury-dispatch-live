        ...
        var stop_data = [];
         var delivery_map;
                ...
                function createTripRequest(data_modal) {
                    ...
                    var assign_method = checkedRadioButton && checkedRadioButton.value ? checkedRadioButton.value : '0';
                    ...
                    if (dataModal == 'book-hourly') {
                        
                        var requestDate = $('#date_picker').val();
                        tripData.trip_start_time = requestDate + ':00';
                        console.log('dataModal', requestDate, dataModal);
                    }
                    // console.log('tripData', tripData);debugger;
                    ...
                    fetch(etaUrl, {
                        ...
                        .then(result => {
                            if (result.success) {
                                ...
                                if(etaResponse.driver_arival_estimation != null && etaResponse.driver_arival_estimation != "" && etaResponse.driver_arival_estimation != undefined){
                                    $('.etatime').html(
