...
class FleetDriversController extends BaseController
{
    ...
    public function addDriver(Request $request){
            Log::info('AddDriver', $request->all());
        ...
        $owner_detail = Owner::where("email", $request->owner_email)->first();
        ...
        // } else {
            $user = User::create([
                ...
                'timezone'=>$owner_detail->user ? $owner_detail->user->timezone : "",
                'country'=>$owner_detail->user ? $owner_detail->user->country : "",
        ...
        $created_params = $request->only(['name','mobile','email','address', 'is_owner']);
